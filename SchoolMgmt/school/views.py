...
#     department_data = Student.objects.all()
#     return render(request, 'department/all_department.html', {'department_data': department_data})
def all_departments(request):
    d = Departments.objects.all()
    return render(request, 'department/all_departments.html', {'departments': d})
